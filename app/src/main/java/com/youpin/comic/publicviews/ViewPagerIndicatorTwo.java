...
public class ViewPagerIndicatorTwo extends LinearLayout {
    // tab数量
    ...
    // 标题正常时的颜色
    private static final int COLOR_TEXT_NORMAL = 0xFF636670;
    //标题选中时的颜色
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFF333333;

    public ViewPagerIndicatorTwo(Context context) {
        this(context, null);
    }

    private int padding = 35;//显示的padding
    Context context;

    public ViewPagerIndicatorTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        cursorparams.setMargins(0, 0, 0, 0);
    ...
    protected void highLightTextView(int position) {
        ...
        if (null != view) {
            ...
            c.setImageResource(R.drawable.img_triangle_two);
        }
    }
