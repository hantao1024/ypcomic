...
import com.youpin.comic.publicutils.LogUtils;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public static MotionEvent getRelativeMotionEventInView(View v, MotionEvent srcEvent, AtomicBoolean inView) {
        ...
        inView.set(srcEvent.getX() >= absLeft && srcEvent.getX() < absRight && srcEvent.getY() >= absTop && srcEvent.getY() < absBottom);
     ...
     */
    /*
	 * public Drawable getDrawable(int resId) { return
